...
const NewPlatformHomepage: React.FC = () => {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      summary: "Recap of powerful moments and voices from this year's celebration of Black LGBTQ+ community.",
...
export default NewPlatformHomepage