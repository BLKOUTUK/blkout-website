...
export default function TheoryOfChangeMasonry() {
  ...
  const act2Cards: Card[] = [
    ...
    { id: 13, type: 'statement', size: 'large', imageUrl: '/images/theory-of-change/card-13-app.png', bgGradient: 'from-violet-950 to-purple-950', content: { title: 'Success on dating apps means sharing as little of yourself as possible', body: 'No face, no case, no intimacy' }},
    ...
    { id: 16, type: 'statement', size: 'large', imageUrl: '/images/theory-of-change/card-16-swipe.png', bgGradient: 'from-violet-950 to-purple-950', content: { title: 'Where are the rest of us?', body: 'Scattered across cities, apps, group chats that went quiet.', highlight: 'Not because we don\'t exist. Because we can\'t find each other.' }},
