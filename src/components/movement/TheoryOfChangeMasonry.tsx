...
export default function TheoryOfChangeMasonry() {
  ...
  const act2Cards: Card[] = [
    ...
    { id: 13.5, type: 'statement', size: 'large', bgGradient: 'from-indigo-950 via-purple-950 to-violet-950', content: { title: 'Success on dating apps means sharing as little of yourself as possible', body: 'No face, no case, no intimacy' }},
