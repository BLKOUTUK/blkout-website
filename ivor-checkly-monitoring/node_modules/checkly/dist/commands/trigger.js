...
const trigger_runner_1 = __importDefault(require("../services/trigger-runner"));
...
const test_sessions_1 = require("../rest/test-sessions");
...
class Trigger extends authCommand_1.AuthCommand {
    ...
    async run() {
        ...
        runner.on(abstract_check_runner_1.Events.ERROR, err => {
            if (err instanceof test_sessions_1.NoMatchingChecksError) {
